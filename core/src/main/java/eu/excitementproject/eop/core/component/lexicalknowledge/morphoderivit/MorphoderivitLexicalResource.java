...
import eu.excitementproject.eop.core.component.lexicalknowledge.morphoderivit.EquivalenceClasses.EquivalenceClassesException;

/**
* Wraps MorphoDerivIT lexical resource.
* The file with the rules is "morphoderivit01", in our SVN: trunk/common/data/MorphoDerivIT
...
*
*/
public class MorphoderivitLexicalResource extends LexicalResourceNothingToClose<EmptyRuleInfo>
{
...
public static final String PARAM_MORPHODERIVIT_FILE_NAME = "morphoderivit-file-name";

public static final String RESOURCE_NAME = "MorphoDerivIT";


/**
* File should be "morphoderivit01"
*
* @param morphoderivitFile should be "morphoderivit01"
* @throws LexicalResourceException
*/
public MorphoderivitLexicalResource(File morphoderivitFile) throws LexicalResourceException
{
loadAllRules(morphoderivitFile);
}

public MorphoderivitLexicalResource(ConfigurationParams params) throws LexicalResourceException, ConfigurationException
{
this(params.getFile(PARAM_MORPHODERIVIT_FILE_NAME));
}
...
{
Set<WordAndPartOfSpeech> rulesForLeft = allMorphoderivitRules.getClassOf(waposLeft);
...
Set<WordAndPartOfSpeech> rulesAsWapos = allMorphoderivitRules.getClassOf(wordAndPartOfSpeech);
List<LexicalRule<? extends EmptyRuleInfo>> ret =null;
...
protected void loadAllRules(File morphoderivitFile) throws LexicalResourceException
{
try
{
if (null==posMap) throw new LexicalResourceException("posMap is null");
BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(morphoderivitFile)));
try
{
...
allMorphoderivitRules.addEquivalenceClass(wordsInCategory);
}
...
{
throw new LexicalResourceException("Failed to read morphoderivit file.",e);
}
catch (UnsupportedPosTagStringException e)
{
throw new LexicalResourceException("Failed to read morphoderivit file.",e);
...
{
throw new LexicalResourceException("Failed to build MorphoDerivIT resource.",e);
}
...
protected EquivalenceClasses<WordAndPartOfSpeech> allMorphoderivitRules = new EquivalenceClasses<WordAndPartOfSpeech>(true);
